...
Os arquivos transparentes em `app/src/main/res/drawable-nodpi` são cópias intactas dos PNGs fornecidos pelo usuário, apenas com nomes compatíveis com Android:

- `1ec7bf6a-3fb6-4298-8791-2084a921767f.png` → `onboarding_welcome.png`
- `94f118e2-d375-4ba1-985b-afe0fbb9116b.png` → `onboarding_family.png`
- `555b05ba-657e-495b-9167-59f60d773ff7.png` → `family_connection.png`
